...
key = "terraform_infra_indigo_code/ecs/oms-salesorder-service-terraform.tfstate"
region = "eu-west-1"
...
spring_datasource_url = "jdbc:mysql://vf-cm-dev-ndoms-emea-rds-instance.cvezycky7sah.eu-west-1.rds.amazonaws.com:3306/salesorder?useSSL=false&createDatabaseIfNotExist=true"
spring_datasource_username = "root"

# Other Service specific config(to be reconfigured for every service)
task_family_name = "oms-salesorder"
port = "8081"
