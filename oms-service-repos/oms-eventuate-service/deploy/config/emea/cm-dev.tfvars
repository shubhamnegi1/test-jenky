...
key = "terraform_infra_indigo_code/ecs/oms-eventuate-service-terraform.tfstate"
region = "eu-west-1"
...
spring_datasource_url = "jdbc:mysql://vf-cm-dev-ndoms-emea-rds-instance.cvezycky7sah.eu-west-1.rds.amazonaws.com:3306/eventuate?useSSL=false&createDatabaseIfNotExist=true"
spring_datasource_username = "root"

# Other Service specific config(to be reconfigured for every service)
task_family_name = "oms-eventuate"
port = "8100"
